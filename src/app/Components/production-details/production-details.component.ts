...
InitializeFormControls() {
  this.ProductionDetailsForm = this._fb.group({
    ...
    subContractingUnitName: [this.VendorProduction.SubContractingName, Validators.required],
    natureOfSubContractingUnit: [this.VendorProduction.NatureOfSubContracting, Validators.required],
    ...
    City: [this.VendorProduction.CityCode, [Validators.required, Validators.pattern(this.CityPattern)]],
